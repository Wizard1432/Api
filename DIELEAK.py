...
BOT_TOKEN        = os.getenv("8672040620:AAFsEF47bWYf98XAZjBWeTsI9SAWeLWRmB4")
MONGODB_URI      = os.getenv("mongodb+srv://Leo:irVAM8fqO7kqY6qe@cluster0.ffz99zj.mongodb.net/?appName=Cluster0", "")
DATABASE_NAME    = os.getenv("Leo", "attack_bot")
API_URL          = os.getenv("https://kimstress.st")
API_KEY          = os.getenv("1c6a5b66271c9ee4b15eca632bcb68b3c6a3a9ac68aa787a9d36cff6a85c032c")
ADMIN_IDS        = [int(x.strip()) for x in os.getenv("ADMIN_IDS", "").split(",") if x.strip()]
CHANNEL_ID       = os.getenv("5006353479", "")
CHANNEL_USERNAME = os.getenv("@Leo_max8", "")
CHANNEL_INVITE   = os.getenv("https://t.me/+keQfTPva3h5kMzM1", "")
